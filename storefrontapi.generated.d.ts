...
export type LayoutQueryVariables = StorefrontAPI.Exact<{
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  desktopHeaderHandle: StorefrontAPI.Scalars['String']['input'];
  mobileHeaderHandle: StorefrontAPI.Scalars['String']['input'];
...
export type LayoutQuery = {
  ...
  desktopHeaderMenu?: StorefrontAPI.Maybe<
  ...
  >;
  mobileHeaderMenu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id'> & {
      items: Array<
        Pick<
          StorefrontAPI.MenuItem,
...
export type YoungestChildMenuItemFragment = Pick<
  StorefrontAPI.MenuItem,
  'id' | 'resourceId' | 'tags' | 'title' | 'type' | 'url'
>;
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      metafields: Array<
        StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value' | 'key'>>
      >;
      variants: {
        nodes: Array<
          Pick<
